...
bool QwintoRow<C>::validate(int index, int value) {
    ...
    int indexToLeft = nullptr;
    int indexToRight = nullptr;
    int valueToLeft = nullptr;
    int valueToRight = nullptr;
    ...
    //Accepting corners
    if (indexToLeft == nullptr && index >= 0 ){
        return true;
    } else if (indexToRight == nullptr && index < 9) {
        return true;
    }

    //Accepting in between values
    if (indexToLeft != nullptr && indexToRight != nullptr) {
